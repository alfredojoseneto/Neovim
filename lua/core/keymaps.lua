...
-- Insert lines ==== or --- insert_mode
keymap("i", "\\a=", "<ESC>20a=<ESC>a" , opts)
keymap("i", "\\a-", "<ESC>20a-<ESC>a" , opts)
keymap("i", "\\<S-a>=", "<ESC>80A=<ESC>80|Dj0" , opts)
keymap("i", "\\<S-a>-", "<ESC>80A-<ESC>80|Dj0" , opts)
keymap("i", "\\i=", "<ESC>20i=<ESC>a" , opts)
keymap("i", "\\i-", "<ESC>20i-<ESC>a" , opts)
keymap("i", "\\<S-i>=", "<ESC>80I=<ESC>80|Dj0" , opts)
keymap("i", "\\<S-i>-", "<ESC>80I-<ESC>80|Dj0" , opts)
